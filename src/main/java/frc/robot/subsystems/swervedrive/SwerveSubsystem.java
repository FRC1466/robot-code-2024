...
{      if(DriverStation.isDSAttached()||DriverStation.isFMSAttached()){}
  ...
  private Pose3d positionNew() {
    return new Pose3d(new Translation3d(0,0,0), new Rotation3d());
  }
    private Pose3d positionNew(Pose3d newPose) {
    return new Pose3d(new Translation3d(0,0,0), new Rotation3d());
  }
